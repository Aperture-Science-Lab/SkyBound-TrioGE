...
void loadPPM(GLuint *textureID, char *strFileName, int width, int height, int wrap) {
	...
	glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, wrap ? (GLfloat)GL_REPEAT : (GLfloat)GL_CLAMP);
	glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, wrap ? (GLfloat)GL_REPEAT : (GLfloat)GL_CLAMP);
